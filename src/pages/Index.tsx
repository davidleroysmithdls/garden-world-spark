...
const Index = () => {
  ...
  const reviews = [{
    name: "Sarah Johnson",
    rating: 5,
    text: "Absolutely fantastic work on our new driveway. Professional, punctual, and the quality is outstanding. Highly recommend Contractor Pros!",
    location: "Manchester"
  }, {
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3 md:space-x-6">
            <Button onClick={handleCallClick} className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-4 py-2 md:px-6" size="sm">
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img alt="Beautiful garden construction work" className="rounded-2xl shadow-2xl w-full h-[500px] object-cover" src="/lovable-uploads/49d67e18-b63d-4ba3-bfd9-2ef6cce8c758.jpg" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <img src="https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=100&h=100&fit=crop&crop=center" alt="Checkatrade Logo" className="w-16 h-16 mx-auto mb-3 object-contain" />
              <p className="font-semibold text-gray-700">Checkatrade</p>
              <p className="text-sm text-gray-500">Approved</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <img src="https://images.unsplash.com/photo-1524230572899-a752b3835840?w=100&h=100&fit=crop&crop=center" alt="Trading Standards Logo" className="w-16 h-16 mx-auto mb-3 object-contain" />
              <p className="font-semibold text-gray-700">Trading Standards</p>
              <p className="text-sm text-gray-500">Approved</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <img src="https://images.unsplash.com/photo-1459767129954-1b1c1f9b9ace?w=100&h=100&fit=crop&crop=center" alt="Insurance Logo" className="w-16 h-16 mx-auto mb-3 object-contain" />
